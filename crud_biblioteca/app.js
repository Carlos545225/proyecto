...
// Middleware para variables globales del layout
app.use((req, res, next) => {
    res.locals.active = req.path.split('/')[2] || 'panel';
    next();
});
...
const prestamosRoutes = require('./routes/administrador/prestamos/index');

// Importar rutas de lectores
const lectorRoutes = require('./routes/lectores/lectores');
...
app.use('/admin/prestamos', isAuthenticated, isBibliotecarioOrAdmin, prestamosRoutes);
...
// Usar las rutas de lectores
app.use('/lectores', lectorRoutes);
