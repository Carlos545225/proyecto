...
from model import db, usuario, paciente as Paciente, medico as Medico, cita as Cita, historia_clinica, factura as Factura
...
def configuracion(): 
    return render_template('panel/configuracion.html')
